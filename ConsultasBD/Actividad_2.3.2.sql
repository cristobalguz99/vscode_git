...
COALESCE(TO_CHAR(MAX(CASE WHEN TTC.COD_TPTRAN_TARJETA = 101 THEN TTC.MONTO_TOTAL_TRANSACCION 
                            ELSE null END), 'L99g999g999'), '0') as "MONTO TOTAL COMPRA",
COALESCE(TO_CHAR(MAX(CASE WHEN TTC.COD_TPTRAN_TARJETA = 102 THEN TTC.MONTO_TOTAL_TRANSACCION 
                            ELSE null END), 'L99g999g999'), '0') as "MONTO TOTAL AVANCE",
COALESCE(TO_CHAR(MAX(CASE WHEN TTC.COD_TPTRAN_TARJETA = 103 THEN TTC.MONTO_TOTAL_TRANSACCION 
                            ELSE null END), 'L99g999g999'), '0') as "MONTO TOTAL S AVANCE"
FROM CLIENTE C
INNER JOIN COMUNA CO ON CO.COD_COMUNA = C.COD_COMUNA
